...
3. The add-on appears in the store under a new "SmartHeat for Home Assistant" section. Install,
   configure (`hostname`, `local_port`, `service_token_id`, `service_token_secret`), start.
